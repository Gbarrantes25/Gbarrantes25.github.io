...
function encriptar() {
    ...
    if(texto != "" && /^[ a-zA-ZñÑ]+$/igm.test(texto)){
        ...
        // Sino cumple la condición, a la SweetAlert le damos los siguientes parámetros para que se muestren en pantalla.
        swal({
            title: "Incorrecto",
            text: "Texto no debe contener caracteres especiales, tildes y números...",
            icon: "error",
            dangerMode: true,
            button: "Cerrar",
        });
...
const btnEncriptar = document.getElementById("btn-new");

btnEncriptar.addEventListener('click', ()=>alerta.classList.add('alerta--show'));
